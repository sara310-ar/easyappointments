...
class Email extends EA_Controller {
    ...
    )
    {
        ...
        $html = $this->CI->load->view('emails/appointment_details', [
            ...
            'appointment_city' => $this->CI->cities_model->get_row($customer['city_id']),
            'appointment_location' => isset($customer['location_id']) ?  $this->CI->cities_model->get_location_row($customer['location_id']) : null,
    ...
    )
    {
        ...
        $html = $this->CI->load->view('emails/delete_appointment', [
            ...
            'appointment_timezone' => $timezones[empty($timezone) ? $provider['timezone'] : $timezone],
            'appointment_city' => $appointment['start_datetime'],
            'appointment_location' => $appointment['start_datetime'],
            'company_link' => $settings['company_link'],
            'company_name' => $settings['company_name'],
            'customer_name' => $customer['first_name'] . ' ' . $customer['last_name'],
            'customer_email' => $customer['email'],
